...
void scroll_note()	//welcome note
{
	...
	gotoxy(27,13);cout<<"HIMA ATM SERVICES";
	...
	gotoxy(56,23);cout<<"HIMA    +447735980734";
	gotoxy(56,24);cout<<"CUSTOMERS SERVICE   +44 7818 977577";
	Sleep(2000);
...
void machine::note()	//final !!!
{
	...
	cout<<"YOUR OPINIONS ARE IMPORTANT TO US TO DEVELOP THE APPLICATION..";gotoxy(10,14);

	cout<<"THANKS ";gotoxy(10,17);
	cout<<"CONTACT US AT : HIMAALHAMOUDDIRECTOE@ICLOUD.COM";gotoxy(24,18);
	cout<<"HOPE YOU LIKE OUR SERVICES ";gotoxy(10,20);
	gotoxy(58,22);
	cout<<"HIMA PRODUCTION.";
